...
class TestCategorizerUI(ConfigLoaderTestBase):
    def setUp(self):
        ...
        self.config_loader.get_combined_paths = Mock(
            return_value={"path1": "/mock/path1", "path2": "/mock/path2"}
        )
    ...
    def test_categorize_all(self, mock_exists):
        ...
        self.assertEqual(
            self.mock_factory.get_categorizer.call_count,
            len(self.config_loader.get_categories.return_value),
        )
        self.assertEqual(
